...
<div class="col-sm-6 maincontentheight  py-5"><!--Start Assigned Work 3rd Column-->
	<form action="" method="POST">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="request_desc" name="requestdesc" value="<?php  if(isset($row['request_desc'])){echo $row['request_desc'];}?>">
		</div>
		<div class="form-group">
		...
		<div class="form-row d-md-flex">
			<div class="form-group col-md-8">
				...
				<input type="text" class="form-control" id="requesteremail" name="requesteremail" value="<?php  if(isset($row['requester_email'])){echo $row['requester_email'];}?>">
			</div>
			<div class="form-group col-md-4">
		...
		<div class="form-row d-md-flex">
			<div class="form-group col-md-6">
				...
				<select name="assigntech" class="form-control">
					...
					<?php
						$sqlquery ="SELECT empName FROM technician_tb";
			...
			<div class="form-group col-md-6">
				...
				<input type="date" class="form-control" id="inputDate" name="inputdate" value="<?php  if(isset($row['requester_date'])){echo $row['requester_date'];}?>">
			</div>
		</div>
		<div class="" style="float:right;">
			<button type="submit" class="btn btn-success mt-3" name="assign">Assign</button>
